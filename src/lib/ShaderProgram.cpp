...
void initShaders() {
  spLambert = new ShaderProgram("./shaders/lambert.vert", NULL,
                                "./shaders/lambert.frag");
  spConstant = new ShaderProgram("./shaders/constant.vert", NULL,
                                 "./shaders/constant.frag");
  spTextured = new ShaderProgram("./shaders/textured.vert", NULL,
                                 "./shaders/textured.frag");
  spColored = new ShaderProgram("./shaders/colored.vert", NULL,
                                "./shaders/colored.frag");
  spLambertTextured = new ShaderProgram("./shaders/lamberttextured.vert", NULL,
                                        "./shaders/lamberttextured.frag");
}
...
#pragma warning(suppress : 4996) // Turn off an error in Visual Studio stemming
                                 // from Microsoft not adhering to standards
...
#pragma warning(suppress : 6386) // Turn off an error in Visual Studio stemming
                                 // from incorrent static code analysis
...
// The method reads a shader code, compiles it and returns a corresponding
// handle
GLuint ShaderProgram::loadShader(GLenum shaderType, const char *fileName) {
  // Create a shader handle
  GLuint shader =
      glCreateShader(shaderType); // shaderType to GL_VERTEX_SHADER,
                                  // GL_GEOMETRY_SHADER lub GL_FRAGMENT_SHADER
